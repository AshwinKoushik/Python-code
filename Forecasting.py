import pandas as pd
Amtrak = pd.read_csv("E:\\Excelr Data\\Python Codes\\Forecasting_Python\\Amtrak.csv")
...
predict_data = pd.read_csv("E:\\Excelr Data\\Python Codes\\Forecasting_Python\\Predict_new.csv")
