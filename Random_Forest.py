...
Diabetes = pd.read_csv("E:\\Data Science\\Decision Tree & random forest\\Diabetes_RF.csv")
Diabetes.head()
Diabetes.columns
...
######################### IRIS data set ##############3
iris = pd.read_csv("E:\\Excelr Data\\Python Codes\\KNN\\iris.csv")
...
salary_train = pd.read_csv("E:\\Excelr Data\\Python Codes\\Random Forests\\SalaryData_Test.csv")
salary_test = pd.read_csv("E:\\Excelr Data\\Python Codes\\Random Forests\\SalaryData_Test.csv")

colnames = salary_train.columns
len(colnames[0:13])
trainX = salary_train[colnames[0:13]]
trainY = salary_train[colnames[13]]
rfsalary = RandomForestClassifier(n_jobs=2,oob_score=True,n_estimators=100,criterion="entropy")
...
pd.crosstab(trainY,trainX["rf_pred"])
# Accuracy
