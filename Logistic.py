# =============================================================================
# Logistic regression for Claimants data whether dependent varibale attorney 0 or 1
# =============================================================================
...
#Importing Data
claimants = pd.read_csv("E:\\Data Science\\Logistic Regression\\claimants.csv")
...
# other way of filling the missing value with mean of that column
...
confusion_matrix
accuracy_train = (296+357)/(938) # 69.61
accuracy_train
...
confusion_matrix
accuracy_test = (129+151)/(402) # 69.65
accuracy_test
