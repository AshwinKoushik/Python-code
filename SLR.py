...
wcat=pd.read_csv("E:\\Data Science\\Linear Regression\\SLR\\wc-at.csv")
wcat.columns
...
#wcat.corr()
wcat.AT.corr(wcat.Waist) # # correlation value between X and Y cor(y,x)
...
plt.scatter(x=wcat['Waist'],y=wcat['AT'],color='red');plt.plot(wcat['Waist'],pred,color='black');plt.xlabel('WAIST');plt.ylabel('AT')
